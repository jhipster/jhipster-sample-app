...
import com.mycompany.myapp.config.reload.instrument.hibernate.JHipsterEntityManagerFactoryWrapper;
...
public class LiquibaseReloader {
    ...
    public void reloadEvent(List<Class> entities) {
        ...
        try {
            final String packagesToScan = "com.mycompany.myapp.domain";
