...
import com.mycompany.myapp.config.reload.reloader.JacksonReloader;
import com.mycompany.myapp.config.reload.reloader.LiquibaseReloader;
import com.mycompany.myapp.config.reload.reloader.SpringReloader;
    ...
    public void reloadEvent(String typename, Class<?> clazz) {
        synchronized (lock) {
            ...
            if (AnnotationUtils.findAnnotation(clazz, Repository.class) != null ||
                ...
                startReloading = true;
            } else if (typename.startsWith("com.mycompany.myapp.domain")) {
