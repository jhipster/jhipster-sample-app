...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.11-build.2189+sha.95f0bf9/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.11-build.2189+sha.95f0bf9',    // all of these placeholder strings will be replaced by grunt's
