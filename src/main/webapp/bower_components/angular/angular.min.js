...
(function (X, O, r) {
        ...
        return b.module || (b.module = function () {
            ...
            return function (e, g, f) {
                ...
                return b[e] || (b[e] = function () {
                    ...
                    var c = [], d = [], l = b("$injector", "invoke"), n = {_invokeQueue: c, _runBlocks: d, requires: g, name: e, provider: b("$provide", "provider"), factory: b("$provide", "factory"), service: b("$provide", "service"), value: b("$provide", "value"), constant: b("$provide", "constant", "unshift"), animation: b("$animateProvider", "register"), filter: b("$filterProvider",
                        "register"), controller: b("$controllerProvider", "register"), directive: b("$compileProvider", "directive"), config: l, run: function (a) {
                        d.push(a);
                        return this
                    }};
                    f && l(f);
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$http", "$templateCache", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function (a, b, l, n, p, s, D, u, Q, z, Y, H) {
            ...
            function N(a, c, d, e, g, f, m, n, p) {
                ...
                for (var la = !1, Ga = !1, v = d.$$element = x(c), G, ea, t, F = e, A, L = 0, M = a.length; L < M; L++) {
                    ...
                    if (G.templateUrl)C("template", N, G, v), N = G, G.replace && (f = G), Q = B(a.splice(L, a.length - L), v, d, g, F, m, n, {controllerDirectives: z, newIsolateScopeDirective: E, templateDirective: N, nonTlbTranscludeDirective: p}), M = a.length; else if (G.compile)try {
            ...
            function la(b, e, g, f, k, n, p) {
                ...
                if (c.hasOwnProperty(e)) {
                    ...
                    for (var D = 0, u = e.length; D < u; D++)try {
                        s = e[D], (f === r || f > s.priority) && -1 != s.restrict.indexOf(g) && (n && (s = Rb(s, {$$start: n, $$end: p})), b.push(s), k = s)
                    } catch (y) {
                        l(y)
                    }
                }
            ...
            function B(a, b, c, d, e, g, f, m) {
                var k = [], l, s, D = b[0], u = a.shift(), y = F({}, u, {templateUrl: null, transclude: null, replace: null, $$originalDirective: u}), Y = I(u.templateUrl) ? u.templateUrl(b, c) : u.templateUrl;
                b.html("");
            ...
            function t(a, c) {
                var d = b(c, !0);
                d && a.push({priority: 0, compile: ba(function (a, b) {
            ...
            Eb.prototype = {$normalize: ma, $addClass: function (a) {
    ...
    function kd() {
        ...
        }], headers: {common: {Accept: "application/json, text/plain, */*"}, post: d, put: d, patch: d}, xsrfCookieName: "XSRF-TOKEN", xsrfHeaderName: "X-XSRF-TOKEN"}, g = this.interceptors = [], f = this.responseInterceptors = [];
        this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function (a, b, c, d, n, p) {
            function s(a) {
                ...
                var d = {transformRequest: e.transformRequest,
                    transformResponse: e.transformResponse}, g = function (a) {
                    function b(a) {
                        var c;
                        q(a, function (b, d) {
    ...
    function wd(b, a) {
        ...
        var e = function () {
            ...
            return a && I(a.then) ? a : {then: function (c) {
                var d = e();
                b(function () {
                    d.resolve(c(a))
                });
            ...
            ["$injector", "$exceptionHandler", "$parse", "$browser", function (c, d, e, g) {
                ...
                f.prototype = {constructor: f,
                    $new: function (a) {
                        ...
                        var d = m(a, "watch"), e = this.$$watchers, f = {fn: b, last: k,
                            get: d, exp: a, eq: !!c};
                        if (!I(b)) {
                        ...
                        }, defaultPrevented: !1}, k = [h].concat(ta.call(arguments, 1)), m, l;
                        do {
                            e = f.$$listeners[a] || c;
                            h.currentScope = f;
                            m = 0;
    ...
    function Cd() {
        this.$get = ["$window", "$document", function (b, a) {
            ...
            return{history: !(!b.history || !b.history.pushState || 4 > d || e), hashchange: "onhashchange"in b && (!f || 7 < f), hasEvent: function (a) {
                ...
                transitions: l, animations: n, msie: M, msieDocumentMode: f}
        }]
    }
    ...
    function wa(b, a) {
        ...
        return{href: U.href, protocol: U.protocol ? U.protocol.replace(/:$/, "") : "", host: U.host, search: U.search ? U.search.replace(/^\?/, "") : "", hash: U.hash ? U.hash.replace(/^#/, "") : "", hostname: U.hostname, port: U.port, pathname: "/" === U.pathname.charAt(0) ? U.pathname : "/" + U.pathname}
    }
    ...
    var Sc = /[A-Z]/g, Od = {full: "1.2.3", major: 1, minor: 2, dot: 3, codeName: "unicorn-zapper"}, Ra = L.cache = {}, eb = L.expando = "ng-" + (new Date).getTime(), Wc = 1, Gc = X.document.addEventListener ? function (b, a, c) {
    ...
    }, Uc = /([\:\-\_]+(.))/g, Vc = /^moz([A-Z])/, xb = A("jqLite"), Da = L.prototype = {ready: function (b) {
        function a() {
            c || (c = !0, b())
        }
    ...
    }, length: 0, push: Nd, sort: [].sort, splice: [].splice}, gb = {};
    ...
    q({removeData: Zb, dealoc: Qa, on: function a(c, d, e, g) {
        ...
        after: function (a, c) {
            ...
            d = d || [];
            var e = [
                {preventDefault: v, stopPropagation: v}
            ];
            q(c, function (c) {
    ...
    }, mc = A("$interpolate"), Rd = /^([^\?#]*)(\?([^#]*))?(#(.*))?$/, rd = {http: 80, https: 443, ftp: 21}, Hb = A("$location");
    rc.prototype = Ib.prototype = qc.prototype = {$$html5: !1, $$replace: !1, absUrl: hb("$$absUrl"), url: function (a, c) {
    ...
    var xa = A("$parse"), vc = {}, qa, Ja = {"null": function () {
        return null
    }, "true": function () {
        return!0
    }, "false": function () {
    ...
    Kb.prototype = {constructor: Kb, lex: function (a) {
        ...
        for (a = []; this.index < this.text.length;) {
            ...
            if (this.is("\"'"))this.readString(this.ch); else if (this.isNumber(this.ch) || this.is(".") && this.isNumber(this.peek()))this.readNumber(); else if (this.isIdent(this.ch))this.readIdent(), this.was("{,") && ("{" === a[0] && (c = this.tokens[this.tokens.length - 1])) && (c.json = -1 === c.text.indexOf(".")); else if (this.is("(){}[].,;:?"))this.tokens.push({index: this.index, text: this.ch, json: this.was(":[,") &&
                this.is("{[") || this.is("}]:,")}), this.is("{[") && a.unshift(this.ch), this.is("}]") && a.shift(), this.index++; else if (this.isWhitespace(this.ch)) {
                this.index++;
                continue
            } else {
                var d = this.ch + this.peek(), e = d + this.peek(2), g = Ja[this.ch], f = Ja[d], h = Ja[e];
                h ? (this.tokens.push({index: this.index, text: e, fn: h}), this.index += 3) : f ? (this.tokens.push({index: this.index, text: d, fn: f}), this.index += 2) : g ? (this.tokens.push({index: this.index, text: this.ch, fn: g, json: this.was("[,:") && this.is("+-")}), this.index += 1) : this.throwError("Unexpected next character ",
    ...
    Cc.$inject = ["$parse"];
    var Td = ba({restrict: "E", compile: function (a, c) {
    ...
    var Hc = function (a) {
            return["$timeout",
                function (c) {
                    return{name: "form", restrict: a ? "EAC" : "E", controller: Fc, compile: function () {
        ...
        Xd = /^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,6}$/, Yd = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/, Ic = {text: ob, number: function (a, c, d, e, g, f) {
            ob(a, c, d, e, g, f);
        ...
        }, hidden: v, button: v, submit: v, reset: v}, Jc = ["$browser", "$sniffer", function (a, c) {
        ...
        lb = "ng-valid", kb = "ng-invalid", Ia = "ng-pristine", nb = "ng-dirty", Zd = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse", function (a, c, d, e, g) {
            ...
            return{require: ["ngModel", "^?form"], controller: Zd, link: function (a, c, d, e) {
                var g =
                    e[0], f = e[1] || mb;
                f.$addControl(g);
        ...
        }, ae = ba({require: "ngModel", link: function (a, c, d, e) {
        ...
        }], he = Mb("", !0), ie = Mb("Odd", 0), je = Mb("Even", 1), ke = sa({compile: function (a, c) {
            c.$set("ngCloak", r);
            ...
            return{restrict: "E", require: ["select", "?ngModel"], controller: ["$element", "$scope", "$attrs", function (a, c, d) {
                ...
                function n(e, f, g) {
                    function h() {
                        ...
                        v || (w || null === t ? a[""].unshift({id: "",
                            label: "", selected: !r}) : r || a[""].unshift({id: "?", label: "", selected: !0}));
                        A = 0;
                        for (z = c.length; A < z; A++) {
                            d = c[A];
                            k = a[d];
                            y.length <= A ? (t = {element: H.clone().attr("label", d), label: k.label}, u = [t], y.push(u), f.append(t.element)) : (u = y[A], t = u[0], t.label != d && t.element.attr("label", t.label = d));
                            E = null;
                            J = 0;
                            for (C = k.length; J < C; J++)r = k[J], (d = u[J + 1]) ? (E = d.element, d.label !== r.label && E.text(d.label = r.label), d.id !== r.id && E.val(d.id = r.id), E[0].selected !== r.selected && E.prop("selected", d.selected = r.selected)) : ("" === r.id && w ? I =
                                w : (I = F.clone()).val(r.id).attr("selected", r.selected).text(r.label), u.push({element: I, label: r.label, id: r.id, selected: r.selected}), E ? E.after(I) : t.element.append(I), E = I);
    ...
    (Ba = X.jQuery) ? (x =
        Ba, F(Ba.fn, {scope: Da.scope, isolateScope: Da.isolateScope, controller: Da.controller, injector: Da.injector, inheritedData: Da.inheritedData}), wb("remove", !0, !0, !1), wb("empty", !1, !1, !1), wb("html", !1, !1, !0)) : x = L;
    cb.element = x;
    (function (a) {
        F(a, {bootstrap: Xb, copy: ga, extend: F, equals: Aa, element: x, forEach: q, injector: Yb, noop: v, bind: rb, toJson: oa, fromJson: Tb, identity: za, isUndefined: C, isDefined: B, isString: w, isFunction: I, isObject: V, isNumber: qb, isElement: Nc, isArray: K, version: Od, isDate: Ka, lowercase: t, uppercase: Ha, callbacks: {counter: 0},
            $$minErr: A, $$csp: Sb});
        Ua = Tc(X);
        try {
            Ua("ngLocale")
        ...
        Ua("ng", ["ngLocale"], ["$provide", function (a) {
            ...
            a.provider("$compile", gc).directive({a: Td, input: Jc, textarea: Jc, form: Ud, script: ze, select: Ce, style: Ee, option: De, ngBind: ee, ngBindHtml: ge, ngBindTemplate: fe, ngClass: he, ngClassEven: je, ngClassOdd: ie, ngCloak: ke, ngController: le, ngForm: Vd, ngHide: te, ngIf: me, ngInclude: ne, ngInit: oe, ngNonBindable: pe, ngPluralize: qe, ngRepeat: re, ngShow: se, ngStyle: ue,
                ngSwitch: ve, ngSwitchWhen: we, ngSwitchDefault: xe, ngOptions: Be, ngTransclude: ye, ngModel: $d, ngList: be, ngChange: ae, required: Kc, ngRequired: Kc, ngValue: de}).directive(Nb).directive(Lc);
            a.provider({$anchorScroll: bd, $animate: Qd, $browser: dd, $cacheFactory: ed, $controller: hd, $document: id, $exceptionHandler: jd, $filter: yc, $interpolate: od, $interval: pd, $http: kd, $httpBackend: ld, $location: sd, $log: td, $parse: ud, $rootScope: xd, $q: vd, $sce: Bd, $sceDelegate: Ad, $sniffer: Cd, $templateCache: fd, $timeout: Dd, $window: Ed})
        }])
    })(cb);
    x(O).ready(function () {
        Rc(O,
