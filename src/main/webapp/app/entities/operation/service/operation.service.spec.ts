...
describe('Operation Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Operation', () => {
      ...
      service.create(operation).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a Operation', () => {
      ...
      service.update(operation).subscribe(resp => (expectedResult = resp));
