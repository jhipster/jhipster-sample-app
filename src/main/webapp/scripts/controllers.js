...
/* Custom Controllers */
jhipsterApp.controller('ProjectController', ['$scope', '$http', 'ProjectService', 'MetricsService', 'HealthCheckService', 'ThreadDumpService',
    function ($scope, $http, ProjectService, MetricsService, HealthCheckService, ThreadDumpService) {
	$scope.updateProjectId = function() {
		...
		angular.forEach($scope.projects,function(value,index){
			...
			// if(project.projectName == $scope.suite.project.project_name){
			// 	$scope.suite.project.projectId = project.projectId;
			// }
        })
	};
