...
jhipsterApp.controller('MainController', function MainController($scope) {

});

jhipsterApp.controller('MenuController', function MenuController($rootScope, $scope, $location, Account, AuthenticationSharedService) {
    $scope.init = function () {
...
jhipsterApp.controller('LoginController', function LoginController($scope, $http, $location, AuthenticationSharedService) {
...
jhipsterApp.controller('PasswordController', function PasswordController($scope, Password) {
    $scope.success = null;
    $scope.error = null;
...
jhipsterApp.controller('SessionsController', function SessionsController($scope, Sessions) {
    $scope.success = null;
    $scope.error = null;
